...
# Language Models
LARGE_CONTEXT_INSTRUCT_LLM = OpenAI(temperature=0.5, model="gpt-4-turbo-preview", cache=True)  # 128k tokens
SMALL_CONTEXT_INSTRUCT_LLM = OpenAI(temperature=0.5, model="gpt-3.5-turbo-1106", cache=True)  # 16k tokens
